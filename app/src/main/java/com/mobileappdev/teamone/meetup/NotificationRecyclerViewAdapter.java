...
import com.mobileappdev.teamone.meetup.NotificationFragment.OnListFragmentInteractionListener;
...
public class NotificationRecyclerViewAdapter extends RecyclerView.Adapter<NotificationRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mNotificationView.setText(mValues.get(position).content);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mView = view;
            mNotificationView = (TextView) view.findViewById(R.id.notification);
        }

        @Override
        public String toString() {
            return super.toString() + " '" + mNotificationView.getText() + "'";
        }
    }
}
